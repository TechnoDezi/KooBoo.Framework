...
namespace KooBoo.Framework.Templating
{
    ...
    public class TemplateParser
    {
        ...
        private Dictionary<string, TemplateParser> _Blocks = new Dictionary<string, TemplateParser>();
        ...
        public Dictionary<string, TemplateParser> Blocks
        {
            get { return _Blocks; }
        }
        ...
        public TemplateParser(Hashtable Variables)
        {
            this._hstValues = Variables;
        }

        public TemplateParser(string FilePath, Hashtable Variables)
        {
            ReadTemplateFromFile(FilePath);
            this._hstValues = Variables;
            ParseBlocks();
        ...
        /// <summary>
        /// Parse template after setting up Template and Variables
        /// </summary>
        /// <returns>
        ...
        private void ParseBlocks()
        {
            ...
            while ((idxCurrent = this._strTemplateBlock.IndexOf(this.BlockTagBeginBegin, idxCurrent)) != -1)
            {
                ...
                TemplateParser block = new TemplateParser();
